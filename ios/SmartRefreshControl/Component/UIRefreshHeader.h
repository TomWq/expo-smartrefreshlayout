...
/** Keep a front-positioned header behind the scroll content. */
@property (nonatomic, assign) BOOL staysBehindContent;

/**
 * Reserve the header height in the scroll view's content inset even when the
 * header uses Front positioning. Fixed-behind headers use that reservation to
 * move content away while the header remains below it.
 */
@property (nonatomic, assign) BOOL expandsContentInset;
